...
//        	email = "noldagaman@gmail.com";
            ...
            realText = "<!DOCTYPE html>\r\n" + 
            		...
            		"		<a style='border: 0; text-decoration: none; padding: 5px 20px; color: #ddd; background: #e55e54;' href='http://ps.noldaga.shop/joinAuth?"+ 
	...
	public static boolean isDateStr(String dateStr) {
		return !dateStr.matches("^((19|20)\\d\\d)?([- /.])?(0[1-9]|1[012])([- /.])?(0[1-9]|[12][0-9]|3[01])$");
	}
